...
//        state = nextstate;
    ...
    //         // Reset RF Timer count register at rising edge of first sync
    //         pulse
    ...
    //         // A second lighthouse can be distinguished by differences in
    //         these
    //         // pulse widths
    ...
    //                 // Dividing the two signals by 50us: 0.000,050/(1/10M) =
    //                 500
    ...
    //                         // time.
    //                         t_d_start = t_0_start;
    //                         // It is only based on sweep that you can
    //                         determine
    //                         // whether you are currently in A or B.
    //                         if (flag_station >= 1) {
    //                             //  Where an even ten digit number is the
    //                             //  X-axis, an odd number is the Y-axis.
    //                             ((t_opt_pulse_us / 10) % 2 == 0) ? (loca_x =
    //                             1)
    //                                                              : (loca_x =
    //                                                              0);
    //                         }
    //                         // Determine whether this is an A or B base
    //                         station
    ...
    //                         if (flag_station >= 1) {
    //                             flag_station++;
    //                             // Exceeding 2 means that a sweep was not
    //                             seen,
    //                             // which often happens.
    //                             if (flag_station >= 3) {
    //                                 flag_station--;
